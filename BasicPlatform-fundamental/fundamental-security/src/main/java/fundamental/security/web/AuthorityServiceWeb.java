...
import fundamental.security.entity.*;
import fundamental.security.service.*;
...
public class AuthorityServiceWeb {
    ...
    private static FundamentalLogger logger = FundamentalLogger.getLogger(AuthorityServiceWeb.class);
